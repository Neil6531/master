            ...
            if(nextIndex < 4){
                setTimeout(function(){ 
                    ...
                    if (window.matchMedia("(max-width: 769px)").matches) {
                        map.panTo(new google.maps.LatLng(22.890, 72.638));
                    }else if (window.matchMedia("(min-width: 770px)").matches) {
                        map.panTo(new google.maps.LatLng(22.984894, 72.632943));
                    }
                }, 1500);
            }
            if(nextIndex == 5){
...
function initMap() {
    map = new google.maps.Map(document.getElementById('map'), {
        center: {lat: 22.984894, lng: 72.632943},
...
var marker = new google.maps.Marker({
    position: {lat: 22.984894, lng: 72.632943},
    map: map,
    icon: iconBase,
    cursor: 'inherit'
});
...
setTimeout(function(){ 
    if (window.matchMedia("(max-width: 769px)").matches) {
        map.panTo(new google.maps.LatLng(22.990, 72.640));
    }else if (window.matchMedia("(min-width: 770px)").matches) { 
        map.panTo(new google.maps.LatLng(22.984894, 72.632943));
    }
}, 5000);
